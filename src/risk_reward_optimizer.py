...
class RiskRewardOptimizer:
    ...
    def __init__(self):
        ...
        self.pattern_adjustments = {
            "heat_wave": {"stop_loss": 0.05, "take_profit": 0.40, "holding": 5},
            "cold_snap": {"stop_loss": 0.06, "take_profit": 0.35, "holding": 4},
            "unusual_warming": {"stop_loss": 0.07, "take_profit": 0.30, "holding": 3},
            "unusual_cooling": {"stop_loss": 0.07, "take_profit": 0.30, "holding": 3},
            "normal": {"stop_loss": 0.08, "take_profit": 0.30, "holding": 2}
        }
    ...
    def optimize_exit_strategy(self, conditions: MarketConditions,
        ...
        if conditions.trend_strength > 0.05 and conditions.weather_confidence > 0.8:
